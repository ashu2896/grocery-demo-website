            ...
            <div className="footer">
                <div className="container">
                    ...
                    <div className="footer-bottom">
                        <h2><Link to="/"><b>T<br />H<br />E</b>Easy-Day Club<span>The Best Supermarket</span></Link></h2>
                        <p className="fo-para">Powered by Ashu sharma </p>
                        ...
                        <div className=" address">
                            ...
                            <div className="col-md-4 fo-grid1">
                                <p><i className="fa fa-phone" aria-hidden="true" />+91 9876543210</p>
                            </div>
                            <div className="col-md-4 fo-grid1">
                                <p><Link to="/gmail.com"><i className="fa fa-envelope-o" aria-hidden="true" />Sharmaashu2809@gmail.com</Link></p>
                            </div>
                            <div className="clearfix" />
                        </div>
                    </div>
                    <div className="copy-right">
                        <p> © 2021 EasyDay Club. All Rights Reserved | Design by   Ashu</p>
                    </div>
                </div>
            </div>
